...
(function (CausesList) {
    ...
    CausesList[CausesList["Tiers/corps \u00E9tranger"] = 1] = "Tiers/corps \u00E9tranger";
    CausesList[CausesList["Intemp\u00E9ries"] = 2] = "Intemp\u00E9ries";
...
class anomalyService extends _ngrx_data__WEBPACK_IMPORTED_MODULE_7__.EntityCollectionServiceBase {
    ...
    getRelatedAnomalies(anode, bnode, depar) {
        anode && anode.trim() !== '' && this.findByCriteria(Object.assign(Object.assign({ page: 1, "status[]": [false, null] }, { node_a: anode.match(/\d+/)[0], depar: depar.match(/\d+/)[0] }), (bnode && bnode.length !== 0 && { node_b: bnode.map((node) => node.match(/\d+/)[0]) })), true);
    }
    /**
     * find By Criteria
     * @param obj query parameters
     */
    findByCriteria(obj, related = false) {
        var _a, _b;
        return (0,tslib__WEBPACK_IMPORTED_MODULE_19__.__awaiter)(this, void 0, void 0, function* () {
            ...
            if (related) {
                ...
                let noRelatedEdges = (_b = !((_a = obj["edge.id[]"]) === null || _a === void 0 ? void 0 : _a.length)) !== null && _b !== void 0 ? _b : true;
                if (noRelatedEdges) {
